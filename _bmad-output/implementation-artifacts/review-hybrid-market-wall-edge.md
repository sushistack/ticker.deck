...
Start a separate fresh session with no prior TickerDeck conversation context.

Invoke the `bmad-review-edge-case-hunter` skill on this diff. Review only; do not modify files. Return concise findings with file/line evidence and explain the user-visible consequence.
